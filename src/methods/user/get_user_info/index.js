...
var users_table_1 = require("../../../tables/users_table");
 ...
 */
function getUserInfo(userId, supabase) {
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            .from(users_table_1.default.tableName)
                            .select()
                            .eq(users_table_1.default.id, userId)
                            .single()];
                case 1:
                    ...
                    return [2 /*return*/, user_1.default.fromJSON(data)];
                case 2:
                    error_1 = _b.sent();
