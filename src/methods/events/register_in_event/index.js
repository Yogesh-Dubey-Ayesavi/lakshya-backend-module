 ...
 */
function registerInEvent(events, supabase) {
    return __awaiter(this, void 0, void 0, function () {
        var authId_1, _a, data, error, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    authId_1 = "271a38f7-49d6-4230-8523-350516c2deee";
                    return [4 /*yield*/, supabase
                            .from(event_users_table_1.default.tableName)
                            .insert(events.map(function (event) {
                            return { event_id: event.id, user_id: authId_1 };
                        }))
                            .select()];
                case 1:
...
exports.default = registerInEvent;
